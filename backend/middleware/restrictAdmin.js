...
module.exports = async (req, res, next) => {
  ...
  if (type == 'admin') {
    ...
    return res.status(403).send({ status: 'Failure', msg: 'You are not authorized to request this resource. You are an administrator and administrators can not access this resource.' });
  }
  return next();
}